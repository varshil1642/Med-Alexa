...
<body>
    ...
    <form class="container d-flex align-items-center justify-content-center py-5" acttion="resubmit.php" method="POST">
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <form acttion="resubmit.php" method="POST" enctype="multipart/form-data">
            <tbody>
            <?php
                            ...
                            echo '
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input class="file-input form-control form-control-sm" id="formFileSm" name='.$report.$date1.' type="file">
                                    </td>
                                    </tr>';
                        }
                    }
            ...
            <?php
                ...
                {
                        $sql2 = "SELECT * FROM `pt_report` WHERE `file` IS NOT NULL";
