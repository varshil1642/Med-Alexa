...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" aria-current="page" href="pathologist.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="pathologist-profile.php">Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="view-report-old1.php">View Report</a>
                    </li>
                    <li class="nav-item">
    ...
    <form class="container d-flex align-items-center justify-content-center py-5" action="pathologist.php" method="POST">
        ...
        <table class="table">
            ...
            <?php
                ...
                if($flag>0)
                {
                    ...
                    $pid = $_POST['pid'];
                    $sql2 = "SELECT * FROM .`pt_report` WHERE `pt_id`='$pid' and `file` IS NULL";
                    $result2 = $conn->query($sql2);
                    if ($result2->num_rows>0)
                    {
                        $i=1;
                        ...
                        while($row2 = $result2 -> fetch_assoc()){
                            ...
                            // $sql3 = "SELECT * FROM .`patient` WHERE `pt_id`='$pid'";
            ...
            <?php
                ...
                {
                        $sql2 = "SELECT * FROM .`pt_report` WHERE `file` IS NULL";
                                ...
                                if(isset($_POST[$pid]))
                                {
                                    if(isset($_POST[$Date])&&!empty($_FILES[$report]['tmp_name']))
                                    {
                                        $pdf1 = addslashes(file_get_contents($_FILES[$report]['tmp_name']));
                                            $addfile="UPDATE .`pt_report` SET `file`='$pdf1' WHERE `pt_id`='$pid' AND `Date`='$Date1' AND `report`='$report1'";
                                    ...
                                    echo "<br>Warning : You haven't uploaded all the files!!";
                                }
                            }
                        }
                }
