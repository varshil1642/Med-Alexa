        ...
        <div class="top d-flex justify-content-around my-5">
            <div class="left-box">
                <div class="mb-3 myflex">
                    ...
                    <input type="text" class="form-control input" id="medicine" name="medicine" placeholder="Medicine"
                        aria-describedby="medicine" onclick=record(id) required>
                </div>
                <div class="mb-3 myflex">
                    <label for="quantity" class="form-label">Quantity</label>
                    <input type="number" class="form-control input" id="quantity" name="quantity" placeholder="Quantity"
                        aria-describedby="quantity" onclick=record(id) required>
                </div>
                <div class="mb-3 myflex">
                    <label for="dosage" class="form-label">Dosage</label>
                    <input type="text" class="form-control input" id="dosage" name="dosage"
                        placeholder="Dosage ex: 1-0-1" aria-describedby="dosage" onclick=record(id) required>
                </div>
            ...
            <div class="right-box">
                <div class="myflex1">
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control input" id="bptop" name="bptop" placeholder="high"
                            aria-describedby="bptop" onclick=record(id) required>
                        <input type="number" class="form-control input" id="bpbottom" name="bpbottom" placeholder="low"
                            aria-describedby="bpbottom" onclick=record(id) required>
                        <span class="igt2 input-group-text" id="basic-addon2">mm Hg</span>
                        <button type="button" id="bp" name="add" class="btn btn-primary"
                            onclick=getAndUpdate2(id)>Add</button>
                    </div>
                </div>
                <div class="myflex1">
                    <div class="input-group mb-3">
                        <span class="igt1 input-group-text">Temperature</span>
                        <input type="number" class="form-control input" id="temperature" name="temperature"
                            placeholder="in deg F" aria-describedby="temperature" onclick=record(id) required>
                        <span class="igt2 input-group-text" id="basic-addon2">deg F</span>
                        <button type="button" id="temp" name="add" class="btn btn-primary"
                            onclick=getAndUpdate2(id)>Add</button>
                    </div>
                </div>
                <div class="myflex1">
                    <div class="input-group mb-3">
                        ...
                        <input type="number" class="form-control input" id="sugar" name="sugar" placeholder="in mg/dL"
                            aria-describedby="sugar" onclick=record(id) required>
                        <span class="igt2 input-group-text" id="basic-addon2">mg/dL</span>
                        <button type="button" id="sug" name="add" class="btn btn-primary"
                            onclick=getAndUpdate2(id)>Add</button>
                    </div>
                </div>
            </div>
    ...
    <div class="mb-1 btnflex">
        <form action="prescription.php" method="POST">
            <div class=" d-flex align-items-center justify-content-center ">
                <button type="submit" id="submitpr" name="submit" class="btn btn-primary"
                    onclick=prescription()>Submit</button>
            </div>
        </form>
    </div>
