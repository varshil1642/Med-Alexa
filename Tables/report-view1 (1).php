...
$username = "varshil1642";
$password = "Vvshah@1642";
$dbname = "med_alexa";
...
<body>
    ...
    <?php
        ...
        {   
            $pid=$_POST['search'];
            $sql = "SELECT * FROM `med_alexa`.`pt_report` WHERE `pt_id`='$pid' AND `file` IS NOT NULL";
            $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0)
                {
                        ...
                        $pid = $row['pt_id'];
                        $sql1= "SELECT * FROM `med_alexa`.`patient` WHERE `pt_id`='$pid'";
    ...
    <div class="report container my-4">
        ...
        <table class="table">
            ...
            <tbody id="tableBody">
                ...
                {
                    $pid = $_POST['search'];
                    $sql2 = "SELECT * FROM `med_alexa`.`pt_report` WHERE `pt_id`='$pid' and `file` IS NOT NULL";
