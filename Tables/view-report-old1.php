...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="pathology-report-view.php">View Report</a>
                    </li>
                    <li class="nav-item">
    ...
    <form autocomplete="" class="container d-flex align-items-center justify-content-center py-5" action="pathology-report-view.php" method="POST">
                    ...
                    if ($result2->num_rows>0)
                    {
                        ...
                        while($row2 = $result2 -> fetch_assoc()){
                            ...
                            echo '<tr>
                                    ...
                                    <form action="pathology-report-view.php" method="POST">
                                    <input type="hidden"  value='.$date.' name="Date">
                                    <input type="hidden"  value='.$report.' name="report">
                                    <input type="hidden" value='.$pid.'  name="pid">
                                    <input type="submit" value="View Report" name="submit_report">
                                    </form>
                                    </div></td>
                                </tr>';
                        }
