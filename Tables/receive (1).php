<?php
    ...
    class MYPDF extends TCPDF {
        ...
        public function Footer() {
            ...
            $this->Cell(66,10,'M - Morning',0,0,'C',0);
            $this->Cell(66,10,'E - Evening',0,0,'C',0);
            $this->Cell(66,10,'N - Night',0,0,'C',0);
    ...
    for($i=0;$i<count($object);$i++)
    {
        ...
        $pdf->Cell(30,5,$object[$i][1],0,0,'C',1);
        $pdf->Cell(30,5,$object[$i][2],0,0,'C',1);
        $pdf->Ln(8);
    }
    ...
    $mail->Subject="Prescription From Med-Alexa";
    ...
    $sql = "INSERT INTO `pt_record` (`dr_id`,`pt_id`,`json`) VALUES('$dr_id','$pt_id','$jsonString')";
    if($con->query($sql)){
        // echo "SUCCESS";
    }
    // exit();
